...
//Ye function based component se banaya hai kyuki hame isme Usestate and hooks ka kaam nhi hai butu PapaNews wali website mai Class based components ka istmaal kiya hai...
const PreNavbar = () => {
    return (
